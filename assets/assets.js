...
export const categories = [
  "Thủy hải sản khô và một nắng",
  "Mắm cá đặc sản",
  "Thức uống tự nhiên",
  "Thực phẩm chế biến sẵn",
  "Bánh kẹo đặc sản truyền thống",
  "Quà lưu niệm",
  "Trái cây sấy đặc sản",
  "Nước chấm, gia vị truyền thống"
];
...
export const dummyStoreData = [
  {
    ...
    description: "At Lumina & Sonic Labs, we believe shopping should be simple, smart, and satisfying. Whether you're hunting for the latest fashion trends, top-notch electronics, home essentials, or unique lifestyle products under one digital roof.",
    username: "happyshop",
