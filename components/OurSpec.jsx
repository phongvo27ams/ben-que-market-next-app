...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Tiêu chuẩn của chúng tôi' description="Chúng tôi mang đến dịch vụ chất lượng cao và trải nghiệm mua sắm tiện lợi, giúp bạn dễ dàng tiếp cận các đặc sản miền Tây chính gốc một cách nhanh chóng, an toàn và hoàn toàn yên tâm." />
